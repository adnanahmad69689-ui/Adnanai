...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || "https://xlskgkechyngzsrttxap.supabase.co";
const supabasePublishableKey = import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || "sb_publishable_ZzHcn69D7BtLSPqhGjJxrw_iLriozqx";
